	...
	<div class="w3-agileits-banner2">
				...
				<div class="w3layouts-header-right">
					<ul>
						<%
                                                ...
                                                {
                                                %>
						<li><a href="profile.jsp" class="log">Profile</a></li>
		...
		<div class="container">
			<div class="agile-logo">
                            <a href="index.html"><img src="images\logo.png" height="100" width="100"> </img></a>
...
<div class="container">
    ...
    <div class="col-md-3 agileits_mail_grid_right10">
        <form action="uploadpublic.jsp" method="POST">
...
<div class="container">
    <div class="col-md-7">
    <div class="services-heading">
        <h3>Upload Private Documents</h3>
    </div>
    <div class="w3-agileits-services-grids">
        <div class="w3-agile-services-right">
            <h5></h5>  
    ...
    <div class="col-md-3 agileits_mail_grid_right10">
        <form action="uploadprivate.jsp" method="POST">
            <center><input type="submit" value="Upload"/></center>
        </form>
    </div>
</div>
<div class="container">
    <div class="col-md-7">
    <div class="services-heading">
        <h3>Upload Confidential Documents</h3>
    </div>
    <div class="w3-agileits-services-grids">
        <div class="w3-agile-services-right">
            <h5></h5>  
    ...
    <div class="col-md-3 agileits_mail_grid_right10">
        <form action="uploadconfidential.jsp" method="POST">
            <center><input type="submit" value="Upload"/></center>
        </form>
    </div>
</div>
...
<div class="agile-footer">
		<div class="container">
			...
			<ul class="aglieits-nav">
				...
				<li><a href="services.jsp">How to Use</a><i>|</i></li>
