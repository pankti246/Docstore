...
<div class="agile-about-top">
		<div class="container">
		<h3 class="agile">About Us</h3>
			<div class="about-section">
				
			   </div>
			   <div class="ab-text">
			         <h3>This is where you will find more about us and the services we provide</h3>
					<p>
					<span></span></p>
				</div>
				<div class="clearfix"> </div>
...
<div class="agile-footer">
		<div class="container">
			...
			<center><div class="w3layouts_mail_grid">
					...
					<div class="modal-body">
						<div class="w3_login_module">
							<div class="module form-module">
							  <div class="toggle"><p style="font-size:40px; margin:13px -1px;"><i class="fa fa-times fa-pencil"></p></i>
